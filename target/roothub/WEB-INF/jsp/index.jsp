	...
	<div class="wrapper">
		...
		<div class="row" style="background-color: #fff;">
			...
			<div class="col-md-4" style="padding-right: 0px;padding-left: 0px;">
				<div class="box box-warning" style="border-top-color: #fff;border-bottom: 0px solid #e2e2e2;margin-bottom: 0px;box-shadow: 0 0px 0px rgba(0,0,0,0.1);">
