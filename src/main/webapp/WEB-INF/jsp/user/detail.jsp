...
<html>
<head>
<title>宠物信息服务平台-${user.userName}</title>
	...
	<div class="wrapper">
		...
		<!-- 小屏幕显示 -->
                ...
                <div class="grade-box clearfix" style="display: flex !important;padding-top: 0px;padding-left: 24px;">
                    ...
                    <dl title="${user.userName}加入宠物信息服务平台的时间">
                        <dt>入驻：</dt>
    ...
    <table cellpadding="0" cellspacing="0" border="0" width="100%">
        <tbody><tr>
            ...
            <c:if test="${user2 != null && user2.userId != user.userId}">
                ...
                <span class="gray" style="font-size: 14px;">宠物信息服务平台 第 ${user.userId} 号会员，加入于 <fmt:formatDate type="both" value="${user.createDate}" /><div class="sep5"></div>
                </span> 
            </td>
        </tr>
    </tbody></table>
