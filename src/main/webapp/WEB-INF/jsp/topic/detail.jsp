						...
						<div class="media">
							<div class="media-body">
								...
								<c:if test="${topic.nodeTitle != null}">
									...
									<a href="/n/${topic.nodeTitle}" class="topic-detail-node" id="nodeTitle">${topic.nodeTitle}</a>
								</c:if>
								<div class="sep10"></div>
								<c:choose>
...
<script type="text/javascript">
	...
	$.ajax({
		...
		success:function(data){
			...
			// 如果分类是 社区公告、宠物辟谣、宠物百科
			var nodeTitle = $('#nodeTitle').text();

			if(nodeTitle == '社区公告' || nodeTitle == '宠物辟谣' || nodeTitle == '宠物百科' ) {
				$("#pinglun").hide();
			}
		},
		error:function(data){
